...
library(metathis)
meta() %>%
  meta_name("github-repo" = "https://github.com/chechoid/paw-latam-2021") %>% 
  meta_social(
...
`r emo::ji("gold")` Marta Gascón Corella por su generosidad y pensar en mí para ser parte del #PAWorld2021 y a Federico Barcos por la organización.
